...
sjcl.bitArray = {
  bitSlice: function(a, b, c) {
    a = sjcl.bitArray.ia(a.slice(b / 32), 32 - (b & 31)).slice(1)
  ...
  concat: function(a, b) {
    ...
    return 32 === d
      ? a.concat(b)
      : sjcl.bitArray.ia(b, d, c | 0, a.slice(0, a.length - 1))
  },
...
sjcl.codec.base32 = {
  J: 'ABCDEFGHIJKLMNOPQRSTUVWXYZ234567',
  ea: '0123456789ABCDEFGHIJKLMNOPQRSTUV',
  BITS: 32,
  BASE: 5,
  REMAINING: 27,
  ...
  toBits: function(a, b) {
    ...
    var c = sjcl.codec.base32.BITS,
      ...
      n,
      m = 'base32'
    b && ((k = sjcl.codec.base32.ea), (m = 'base32hex'))
...
sjcl.hash.sha256 = function(a) {
  this.g[0] || this.X()
  a
    ? ((this.N = a.N.slice(0)), (this.I = a.I.slice(0)), (this.A = a.A))
    : this.reset()
}
...
sjcl.hash.sha256.prototype = {
  ...
  update: function(a) {
    ...
    if ('undefined' !== typeof Uint32Array) {
      ...
      for (b = 512 + b - ((512 + b) & 0x1ff); b <= a; b += 512)
        v(this, d.subarray(16 * e, 16 * (e + 1))), (e += 1)
      c.splice(0, 16 * e)
    } else
      for (b = 512 + b - ((512 + b) & 0x1ff); b <= a; b += 512)
        v(this, c.splice(0, 16))
    return this
  },
  finalize: function() {
    var a,
    ...
    for (b.push(this.A | 0); b.length; ) v(this, b.splice(0, 16))
    this.reset()
    return c
  },
  fa: [],
  ...
  X: function() {
    ...
    for (var b = 0, c = 2, d, e; 64 > b; c++) {
      ...
      e &&
        (8 > b && (this.fa[b] = a(Math.pow(c, 0.5))),
        (this.g[b] = a(Math.pow(c, 1 / 3))),
        b++)
    }
  },
}
...
sjcl.mode.ccm = {
  ...
  unListenProgress: function(a) {
    a = sjcl.mode.ccm.O.indexOf(a)
    ;-1 < a && sjcl.mode.ccm.O.splice(a, 1)
  },
  pa: function(a) {
  ...
  encrypt: function(a, b, c, d, e) {
    ...
    f < 15 - k && (f = 15 - k)
    c = h.clamp(c, 8 * (15 - f))
    b = sjcl.mode.ccm.ca(a, b, c, d, e, f)
    g = sjcl.mode.ccm.K(a, g, c, b, e, f)
  ...
  decrypt: function(a, b, c, d, e) {
    ...
    b < 15 - g && (b = 15 - g)
    c = f.clamp(c, 8 * (15 - b))
    k = sjcl.mode.ccm.K(a, k, c, l, e, b)
    a = sjcl.mode.ccm.ca(a, k.data, c, d, e, b)
    if (!f.equal(k.tag, a))
  ...
  ca: function(a, b, c, d, e, f) {
    ...
    c = sjcl.mode.ccm.xa(a, d, c, e, g.bitLength(b) / 8, f)
...
sjcl.mode.gcm = {
  ...
  encrypt: function(a, b, c, d, e) {
    ...
    b = sjcl.bitArray
    d = d || []
    a = sjcl.mode.gcm.K(!0, a, f, d, c, e || 128)
  ...
  K: function(a, b, c, d, e, f) {
    ...
    96 === h
      ...
      : ((e = sjcl.mode.gcm.w(g, [0, 0, 0, 0], e)),
        (e = sjcl.mode.gcm.w(g, e, [
          0,
          0,
          Math.floor(h / 0x100000000),
          h & 0xffffffff,
        ])))
    h = sjcl.mode.gcm.w(g, [0, 0, 0, 0], d)
    n = e.slice(0)
    d = h.slice(0)
    a || (d = sjcl.mode.gcm.w(g, h, c))
    for (l = 0; l < m; l += 4)
      n[3]++,
        (k = b.encrypt(n)),
        (c[l] ^= k[0]),
...
sjcl.misc.hmac.prototype.digest = function() {
  var a = this.Z.finalize(),
    a = new this.da(this.H[1]).update(a).finalize()
  this.reset()
  return a
}
...
sjcl.prng = function(a) {
  ...
  this.W = 0
  this.ba = {}
  this.ha = this.j = this.C = this.ra = 0
  this.g = [0, 0, 0, 0, 0, 0, 0, 0]
  this.m = [0, 0, 0, 0]
  this.U = void 0
  this.V = a
  this.M = !1
  this.T = { progress: {}, seeded: {} }
  this.F = this.qa = 0
  this.R = 1
  this.S = 2
  this.ma = 0x10000
  this.aa = [0, 48, 64, 96, 128, 192, 0x100, 384, 512, 768, 1024]
  this.na = 3e4
  this.la = 80
}
sjcl.prng.prototype = {
  randomWords: function(a, b) {
    ...
    if (d & this.S) {
      ...
      var f = 0,
        g
      this.ha = e[0] = new Date().valueOf() + this.na
      ...
      this.Y >= 1 << this.h.length &&
        (this.h.push(new sjcl.hash.sha256()), this.B.push(0))
      this.j -= f
      f > this.C && (this.C = f)
      this.Y++
      this.g = sjcl.hash.sha256.hash(this.g.concat(e))
      this.U = new sjcl.cipher.aes(this.g)
      for (
        d = 0;
  ...
  addEntropy: function(a, b, c) {
    ...
    var d,
      ...
      k = 0
    d = this.ba[c]
    void 0 === d && (d = this.ba[c] = this.ra++)
    void 0 === g && (g = this.P[c] = 0)
    this.P[c] = (this.P[c] + 1) % this.h.length
    switch (typeof a) {
      case 'number':
        void 0 === b && (b = 1)
        this.h[g].update([d, this.W++, 1, b, f, 1, a | 0])
        break
      case 'object':
      ...
      case 'string':
        void 0 === b && (b = a.length)
        this.h[g].update([d, this.W++, 3, b, f, a.length])
        this.h[g].update(a)
        break
      default:
        k = 1
    ...
    this.j += b
    h === this.F &&
      (this.isReady() !== this.F && A('seeded', Math.max(this.C, this.j)),
      A('progress', this.getProgress()))
  },
  isReady: function(a) {
    a = this.aa[void 0 !== a ? a : this.V]
    return this.C && this.C >= a
      ? this.B[0] > this.la && new Date().valueOf() > this.ha
        ? this.S | this.R
        : this.R
      : this.j >= a
      ? this.S | this.F
  ...
  getProgress: function(a) {
    a = this.aa[a ? a : this.V]
    return this.C >= a ? 1 : this.j > a ? 1 : this.j / a
  },
  startCollectors: function() {
    if (!this.M) {
      this.c = {
        loadTimeCollector: B(this, this.wa),
        mouseCollector: B(this, this.ya),
        keyboardCollector: B(this, this.va),
        accelerometerCollector: B(this, this.oa),
        touchCollector: B(this, this.Aa),
      }
...
function w(a) {
  a.g = z(a).concat(z(a))
  a.U = new sjcl.cipher.aes(a.g)
}
function z(a) {
  for (var b = 0; 4 > b && ((a.m[b] = (a.m[b] + 1) | 0), !a.m[b]); b++);
  return a.U.encrypt(a.m)
}
function B(a, b) {
  return function() {
    b.apply(a, arguments)
...
sjcl.json = {
  ...
  sa: function(a, b, c, d) {
    ...
    d = d || {}
    var e = sjcl.json
    b = e.l(e.l(e.l({}, e.defaults), b), c, !0)
    var f, g
    f = b.adata
...
sjcl.bn.prototype = {
  ...
  addM: function(a) {
    'object' !== typeof a && (a = new this.f(a))
    var b = this.limbs,
      c = a.limbs
  ...
  mul: function(a) {
    'number' === typeof a ? (a = new this.f(a)) : a.normalize()
    this.normalize()
    var b,
      c = this.limbs,
      d = a.limbs,
  ...
  powermod: function(a, b) {
    ...
    for (
      var d, e = a.normalize().trim().limbs, f = new this.f(1), g = this, c = 0;
      c < e.length;
      c++
    )
  ...
  montpowermod: function(a, b) {
    ...
    for (var r = new sjcl.bn(0), q = k.copy(); q.greaterEquals(1); )
      q.halveM(),
        0 == (f.limbs[0] & 1)
          ? (f.halveM(), r.halveM())
          : (f.addM(p), f.halveM(), r.halveM(), r.addM(m))
    f = f.normalize()
    r = r.normalize()
    m.doubleM()
    p = m.mulmod(m, b)
...
sjcl.bn.prime = {
  ...
  p192: I(192, [[0, -1], [64, -1]]),
  p224: I(224, [[0, 1], [96, -1]]),
  p256: I(0x100, [[0, -1], [96, 1], [192, 1], [224, -1]]),
  p384: I(384, [[0, -1], [32, 1], [96, -1], [128, -1]]),
  p521: I(521, [[0, -1]]),
}
...
sjcl.ecc.point.prototype = {
  ...
  multiples: function() {
    ...
    if (void 0 === this.ga)
      for (
        c = this.toJac().doubl(),
          a = this.ga = [new sjcl.ecc.point(this.curve), this, c.toAffine()],
          b = 3;
        16 > b;
        b++
      )
...
sjcl.ecc.basicKey = {
  publicKey: function(a, b) {
    this.i = a
    this.u = a.r.bitLength()
    b instanceof Array ? (this.o = a.fromBits(b)) : (this.o = b)
    this.serialize = function() {
      var b = sjcl.ecc.curveName(a)
      return {
        type: this.getType(),
        secretKey: !1,
        point: sjcl.codec.hex.fromBits(this.o.toBits()),
        curve: b,
      }
    }
    this.get = function() {
...
sjcl.ecc.elGamal.publicKey.prototype = {
  kem: function(a) {
    a = sjcl.bn.random(this.i.r, a)
    var b = this.i.G.mult(a).toBits()
    return { key: sjcl.hash.sha256.hash(this.o.mult(a).toBits()), tag: b }
  },
  getType: function() {
    return 'elGamal'
  },
...
sjcl.ecc.ecdsa.publicKey.prototype = {
  verify: function(a, b, c) {
    sjcl.bitArray.bitLength(a) > this.u && (a = sjcl.bitArray.clamp(a, this.u))
    var d = sjcl.bitArray,
      e = this.i.r,
      f = this.u,
...
sjcl.ecc.ecdsa.secretKey.prototype = {
  sign: function(a, b, c, d) {
    ...
    b = this.i.G.mult(d).x.mod(e)
    a = sjcl.bn.fromBits(a).add(b.mul(this.L))
    c = c
      ? a
          .inverseMod(e)
          .mul(d)
          .mod(e)
      : a.mul(d.inverseMod(e)).mod(e)
